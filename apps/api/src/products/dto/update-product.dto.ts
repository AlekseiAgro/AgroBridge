...
@ValidatorConstraint({ name: 'productCategoryUpdate', async: false })
...
@ValidatorConstraint({ name: 'productUnitUpdate', async: false })
...
@ValidatorConstraint({ name: 'harvestStatusUpdate', async: false })
...
@ValidatorConstraint({ name: 'seasonMonthsUpdate', async: false })
