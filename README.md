...
Configured by default for **agrobridge.ge** (API on **api.agrobridge.ge**). Domain is env-only — see [`docs/DOMAIN.md`](docs/DOMAIN.md) to move later without code changes.
...
1. Deploy on Railway ([`docs/RAILWAY.md`](docs/RAILWAY.md)) or a VPS, then attach `agrobridge.ge`
